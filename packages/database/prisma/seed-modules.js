...
// FINANCE es el gancho de upgrade BASIC → PRO. Solo PRO y UNLIMITED lo incluyen.
const planModules = {
  BASIC:     [],
  PRO:       [MODULE_KIOSK, MODULE_DELIVERY, MODULE_LOYALTY, MODULE_KDS, MODULE_REPORTS, MODULE_FINANCE],
  UNLIMITED: [MODULE_KIOSK, MODULE_DELIVERY, MODULE_WEBSTORE, MODULE_LOYALTY, MODULE_KDS, MODULE_REPORTS, MODULE_FINANCE],
}
