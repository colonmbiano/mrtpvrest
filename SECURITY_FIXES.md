...
- [ ] El password `***ELIMINADO***` estuvo en el código (commits previos a 2026-05-03). Ya está parametrizado vía env, pero **rotar el password en producción** y purgar del historial git si es viable
