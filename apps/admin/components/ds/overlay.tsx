  ...
  return (
    <Overlay onClose={onClose}>
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className={`ds-enter relative flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-ds-xl md:rounded-ds-xl ${SIZES[size]}`}
      ...
      {current && (
        <Overlay onClose={() => settle(false)}>
          <div
            ...
            className="ds-enter relative w-full max-w-sm overflow-hidden rounded-t-ds-xl p-5 md:rounded-ds-xl"
            style={{ background: "var(--surf-1)", border: "1px solid var(--bd-1)", boxShadow: "var(--shadow-lg)" }}
          >
