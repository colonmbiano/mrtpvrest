...
export default function AiKeyCard() {
  ...
  async function remove() {
    if (!confirm("Seguro que quieres borrar la API key? Las funciones IA dejaran de funcionar o usaran la cortesia de plataforma si sigues en trial.")) return;
    setWorking("delete");
    setMsg(null);
    try {
  ...
  const banner = (() => {
    ...
    return { tone: "err", text: "Sin API key. El asistente y las funciones IA de texto estan desactivadas hasta que configures una key de Groq Cloud." };
  })();
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
          ...
          <div>
            ...
            <p style={{ color: "#888", fontSize: 13 }}>
              Potencia el asistente del dashboard y las funciones IA de texto con tu propia API key.
            </p>
          </div>
        </div>
      </div>
