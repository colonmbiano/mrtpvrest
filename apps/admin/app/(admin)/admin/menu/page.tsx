...
// ── Lista editable de opciones (complementos) ─────────────────────────────
// IMPORTANTE: definida a nivel de módulo (no dentro de MenuPage). Si se anida
// dentro del componente padre, React la trata como un tipo nuevo en cada render
// y re-monta el subárbol en cada tecla → el input pierde el foco y en
// tablet/móvil se cierra el teclado.
