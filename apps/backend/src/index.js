...
const corsOptions = {
  origin: (origin, callback) => {
    ...
    if (isMrtpv || isVercel || isLocal || isTauri) {
      callback(null, true);
    } else {
...
app.use('/api/whatsapp/inbox', require('./routes/whatsapp-inbox.routes'))
app.use('/api/whatsapp/upsell', require('./routes/whatsapp-upsell.routes'))
app.use('/api/whatsapp/templates', require('./routes/whatsapp-templates.routes'))
app.use('/api/delivery-zones', require('./routes/delivery-zones.routes'))
