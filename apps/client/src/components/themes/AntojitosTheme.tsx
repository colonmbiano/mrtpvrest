      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            {info.instagramUrl && <a href={info.instagramUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center transition hover:opacity-80" style={{ background: MASA_SOFT, color: accent }} aria-label="Instagram"><Instagram className="w-4 h-4" /></a>}
            {info.facebookUrl && <a href={info.facebookUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center transition hover:opacity-80" style={{ background: MASA_SOFT, color: accent }} aria-label="Facebook"><Facebook className="w-4 h-4" /></a>}
            {info.tiktokUrl && <a href={info.tiktokUrl} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full flex items-center justify-center transition hover:opacity-80" style={{ background: MASA_SOFT, color: accent }} aria-label="TikTok"><Music2 className="w-4 h-4" /></a>}
          </div>
        </div>
