...
// Imagen social compartida por todas las páginas del cluster MODA+ (ropa).
// Sin esto heredan el logo de restaurante del layout raíz. Genérica (sin
// params) para que el render de Satori sea simple y verificable.
export const alt = 'MODA+ — Punto de venta para tu tienda de ropa'
export const size = { width: 1200, height: 630 }
export const contentType = 'image/png'

export default function ModaOgImage() {
